...
This project provides a detailed, end-to-end framework for identifying whether rating labels have been generated by artificial intelligence (specifically, Vertex AI Gemini) or by human labelers. Leveraging a curated subset of the Netflix Prize Dataset and supplementing it with synthetic rating labels generated using Vertex AI's Gemini model, the project facilitates a comprehensive and comparative analysis. It encompasses data preprocessing, targeted feature engineering (with a focus on a core set of statistical indicators), model training, evaluation, and a user-friendly Gradio-based UI for interactive predictions. The core goal is to streamline processes and improve the ability to detect AI generated rating labels with greater ease.
